...
//Dessiner un cadre ref

public class CadreCartes {
    ...
    static float CadreColors[] = {
            0.98f,  0.98f, 0.77f, 1.0f,
            0.98f,  0.98f, 0.77f, 1.0f,
            0.98f,  0.98f, 0.77f, 1.0f,
            0.98f,  0.98f, 0.77f, 1.0f,
            0.98f,  0.98f, 0.77f, 1.0f,
    ...
    public CadreCartes(float[] Pos) {

        Position[0] = Pos[0];
        Position[1] = Pos[1];
        // initialisation du buffer pour les vertex (4 bytes par float)
        ByteBuffer bb = ByteBuffer.allocateDirect(CadreCartes.length * 4);
        bb.order(ByteOrder.nativeOrder());
        vertexBuffer = bb.asFloatBuffer();
        vertexBuffer.put(CadreCartes);
        vertexBuffer.position(0);


        // initialisation du buffer pour les couleurs (4 bytes par float)
        ByteBuffer bc = ByteBuffer.allocateDirect(CadreColors.length * 4);
        bc.order(ByteOrder.nativeOrder());
        colorBuffer = bc.asFloatBuffer();
        colorBuffer.put(CadreColors);
