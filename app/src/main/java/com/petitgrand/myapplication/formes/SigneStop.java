...
public class SigneStop {
    ...
    static float StopCoords[] = {
            ...
            -2.0f,  -2.0f, 0.0f,
            2.0f,  -2.0f, 0.0f};
    static float StopColors[] = {
            0.35f,  0.69f, 0.24f, 1.0f,
            0.35f,  0.69f, 0.24f, 1.0f,
            0.35f,  0.69f, 0.24f, 1.0f,
            0.35f,  0.69f, 0.24f, 1.0f,
            0.35f,  0.69f, 0.24f, 1.0f,
    ...
    public SigneStop(float[] Pos) {

        Position[0] = Pos[0];
        Position[1] = Pos[1];
        // initialisation du buffer pour les vertex (4 bytes par float)
        ByteBuffer bb = ByteBuffer.allocateDirect(StopCoords.length * 4);
        bb.order(ByteOrder.nativeOrder());
        vertexBuffer = bb.asFloatBuffer();
        vertexBuffer.put(StopCoords);
        vertexBuffer.position(0);


        // initialisation du buffer pour les couleurs (4 bytes par float)
        ByteBuffer bc = ByteBuffer.allocateDirect(StopColors.length * 4);
        bc.order(ByteOrder.nativeOrder());
        colorBuffer = bc.asFloatBuffer();
        colorBuffer.put(StopColors);
