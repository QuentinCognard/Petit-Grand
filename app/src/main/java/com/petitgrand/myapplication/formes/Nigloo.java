...
public class Nigloo extends Animal   {
    ...
    static float niglooColors[] = {
            0.29f,  0.30f, 0.22f, 1.0f,
            0.29f,  0.30f, 0.22f, 1.0f,
            0.29f,  0.30f, 0.22f, 1.0f,
            0.29f,  0.30f, 0.22f, 1.0f,
            0.29f,  0.30f, 0.22f, 1.0f,
    ...
    private final short Indices[] = { 0, 1, 2,1,2,3,2,3,4,0,5,4 };
    ...
    public Nigloo(float[] Pos) {

        Position[0] = Pos[0];
        Position[1] = Pos[1];
        // initialisation du buffer pour les vertex (4 bytes par float)
        ByteBuffer bb = ByteBuffer.allocateDirect(niglooCoords.length * 4);
        bb.order(ByteOrder.nativeOrder());
        vertexBuffer = bb.asFloatBuffer();
        vertexBuffer.put(niglooCoords);
        vertexBuffer.position(0);


        // initialisation du buffer pour les couleurs (4 bytes par float)
        ByteBuffer bc = ByteBuffer.allocateDirect(niglooColors.length * 4);
        bc.order(ByteOrder.nativeOrder());
        colorBuffer = bc.asFloatBuffer();
        colorBuffer.put(niglooColors);
    ...
    public float getHeight(){
        return abs(niglooCoords[4])+ abs(niglooCoords[16]);
    }
